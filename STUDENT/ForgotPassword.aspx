<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="STUDENT.ForgotPassword" %>
...
<lottie-player src="https://assets1.lottiefiles.com/packages/lf20_mdyrjbcc.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
        ...
        <asp:Panel ID="panlogin" runat="server">
            <div class="main">
        <p class="sign" align="center">Enter Your Username</p>
       ...
       <asp:Label runat="server" ID="lbl"></asp:Label>
        ...
        <asp:TextBox ID="txtpwd" runat="server" CssClass="pass" align="center" placeholder="New Password"></asp:TextBox>
                <br />
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtpwd"
                    ...
                    <asp:TextBox ID="txtcpwd" runat="server" CssClass="pass" align="center" placeholder="Confirm Password"></asp:TextBox>
                <br />
                <div style="padding-left:150px">
